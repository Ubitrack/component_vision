...
public:
	...
	void compute( Measurement::Timestamp t ) {
		...
		Math::Matrix<4, 4> projMatrix = Calibration::offAxisProjectionMatrix( eye_pos, m_screen_ll, m_screen_ul, m_screen_lr, m_near, m_far, m_screen_width, m_screen_height );
