...
AdaptiveSkinDetector::AdaptiveSkinDetector( const std::string& sName, boost::shared_ptr< Graph::UTQLSubgraph > subgraph )
	...
	, m_inPort( "Input", *this, boost::bind( &AdaptiveSkinDetector::pushImage, this, boost::placeholders::_1 ) )
	, m_configMorphingMode("MorphingMode", *this, boost::bind( &AdaptiveSkinDetector::receiveConfigMorphingMode, this, boost::placeholders::_1 ) )
	, nStartCounter( 0 )
	, nFrameCount( 0 )
